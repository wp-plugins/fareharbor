...
Tags: reservations, booking calendar, booking, booking plugin, reservation calendar, booking system
...
= 2.1 =
* Add support for specifying price sheet to use while booking
